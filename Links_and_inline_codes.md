...
The custom `inline codes` can be customised with the `inline_codes` option.
...
The left corner for the inline codes.
...
The right corner for the inline codes.
...
The left padding for the inline codes. Added after the `left_corner`.
...
The right padding for the inline codes. Added before the `right_corner`.
...
A custom text for the inline codes. This will replace the hyperlink's text.
